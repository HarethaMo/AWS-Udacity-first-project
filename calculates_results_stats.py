...
def calculates_results_stats(results_dic):
    ...
    if n_dogs > 0:
        results_stats_dic['pct_correct_dogs'] = (n_correct_dogs / n_dogs) * 100
        results_stats_dic['pct_correct_breed'] = (n_correct_breed / n_dogs) * 100
    else:
        results_stats_dic['pct_correct_dogs'] = 0.0
        results_stats_dic['pct_correct_breed'] = 0.0
    if n_not_dogs > 0: 
        results_stats_dic['pct_correct_notdogs'] = (n_correct_notdogs / n_not_dogs) * 100
    else:
