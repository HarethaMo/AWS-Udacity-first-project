...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print('Here is how CNN model {} preformed:'.format(model.upper()))
      ...
      if (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) != results_stats_dic['n_images']:         
        for key in results_dic:
          if results_dic[key][3] != results_dic[key][4]:
            print('Animle: {}, Classified as {}'.format(results_dic[key][0], results_dic[key][1]))                   
      else:
        print('None!')                  
      ...
      if results_stats_dic['n_correct_breed'] !=  results_stats_dic['n_correct_dogs']:         
        for key in results_dic:
          if (results_dic[key][3] + results_dic[key][4]) == 2 and (results_dic[key][2] == 0):
            print('Dog Breed: {}, Classified as {}'.format(results_dic[key][0], results_dic[key][1]))                   
      else:
        print('None!') 
